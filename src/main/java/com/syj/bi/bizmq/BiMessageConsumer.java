...
public class BiMessageConsumer {
    ...
    public void receiveMessage(String message, Channel channel, @Header(AmqpHeaders.DELIVERY_TAG) long deliveryTag) throws BusinessException {
        ...
        // 调用 AI
        String result = aiManager.sendMsgToXingHuo(buildUserInput(chart).toString());
